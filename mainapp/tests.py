...
class TestNewsSelenium(StaticLiveServerTestCase):
    ...
    def setUp(self):
        super().setUp()
        self.selenium = WebDriver(executable_path=settings.SELENIUM_DRIVER_PATH_CHROME)
        # self.selenium = WebDriver(executable_path=settings.SELENIUM_DRIVER_PATH_FF, firefox_binary='/snap/firefox/1443/usr/lib/firefox/firefox')
